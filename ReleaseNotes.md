...
- Browser duplicates merged.
- Recursive self-launch entry hidden.
- Chromium profile names improved.
- Draft prompt files ignored.
- Agent guidance added.

## 1.0.0 - 2025-09-12

- Initial WPF browser selector.
- Settings window added.
- Browser detection and launch services added.
- Windows registration resources added.
- Build scripts and solution setup added.
